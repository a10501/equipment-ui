<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="申报日期" prop="badinfoDate">
        <el-date-picker clearable
          v-model="queryParams.badinfoDate"
          type="date"
    ...
    <el-table v-loading="loading" :data="badinfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备报修id" align="center" prop="id" />
      ...
      <el-table-column label="申报日期" align="center" prop="badinfoDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.badinfoDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listBadinfo(this.queryParams).then(response => {
